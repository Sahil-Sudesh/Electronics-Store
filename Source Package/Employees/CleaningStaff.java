...
public class CleaningStaff extends Employee implements Payable {
    private double baseSalary;
    private double bonus;
    private double allowance;

    public CleaningStaff(String name, String email, Date dateOfBirth, int employeeId, int grade) {
    ...
    @Override
    public void work() {
        // Add specific work behavior for cleaning staff
