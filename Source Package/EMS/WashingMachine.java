...
public class WashingMachine extends ElectronicProduct implements help{
    public WashingMachine(String productId,String name, double mrp_price,double costprice,String type)
    {
    	super(productId,name,mrp_price,costprice,type);
    }
    public WashingMachine(String productId,String name, double mrp_price, int quantity,double costprice, String type) {
